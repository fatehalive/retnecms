                        ...
                        <div class="card card-notification">
                            ...
                            <div class="card-body">
                                <div class="card-container-wrapper">
                                    ...
                                    <div class="card-container">
                                        <h6 class="p-0 m-0">Show notifications from:</h6>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                            ...
                            <a class="dropdown-item" href="apps.messages.html">
                                <i class="icon dripicons-mail"></i>Message<span class="badge badge-accent rounded-circle w-15 h-15 p-0 font-size-10">4</span>
                            </a>
                            <a class="dropdown-item" href="pages.profile.html">
                                <i class="icon dripicons-user"></i>Profile
                            </a>
                            <a class="dropdown-item" href="pages.my-account.html">
                                <i class="icon dripicons-gear"></i>Account Settings
                            </a>
