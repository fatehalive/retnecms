...
const createNewsArticle = async (req, res, next) => {
  try {
    ...
    const newNews_Article = await News_Article.create({
      ...
      image1_url: `http://api.retnecms.com/public/image/${image1.uuid}.${image1.type}`,
      image2_url: `http://api.retnecms.com/public/image/${image2.uuid}.${image2.type}`,
...
const updateNewsArticle = async (req, res, next) => {
  try {
    ...
    if (req.files.image1) {
      ...
      let imageRelativeLocation1 = imageFixLocation1.replace('http://api.retnecms.com/public/image/', '')
    ...
    if (req.files.image1) {
      ...
      let imageRelativeLocation2 = imageFixLocation2.replace('http://api.retnecms.com/public/image/', '')
    ...
    if (image1 !== "") {
      updateData['image1_url'] = `http://api.retnecms.com/public/image/${image1.uuid}.${image1.type}`;
    }

    if (image2 !== "") {
      updateData['image2_url'] = `http://api.retnecms.com/public/image/${image2.uuid}.${image2.type}`;
    }
